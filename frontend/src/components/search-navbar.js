class SearchNavbar extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
    <div class="ctx-c_nav">
        <nav class="ctx-nav_bar search-variant">
            <div class="ctx-c_nav_logo">
                <a href="/frontend/src/pages/home/index.html" class="logo">
                    <img src="/frontend/public/nf_logo_nf.png" alt="Nos Fuimos de Finca!">
                </a>
            </div>
            
            <div class="ctx-c_nav_search">
                <div class="search-nav-input-wrapper">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
                    <input type="text" placeholder="Buscar destinos o fincas..." data-i18n="nav.searchPlaceholder">
                </div>
            </div>

            <div class="ctx-c_nav_main_options search-variant-links">
                <ul class="ctx-options">
                    <li>
                        <a href="/frontend/src/pages/home/index.html">
                    ...
                    <li>
                        <a href="/frontend/src/pages/catalog/catalog.html">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M19 20 10 4" />
                                <path d="m5 20 9-16" />
                    ...
                    <li>
                        <a href="/frontend/src/pages/contact/contact.html">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path
                    ...
                    <li>
                        <a href="/frontend/src/pages/contract/contract.html">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
